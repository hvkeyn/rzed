...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "RZed Editor Dev Instance Running",
        ReleaseChannel::Nightly => "RZed Editor Nightly Instance Running",
        ReleaseChannel::Preview => "RZed Editor Preview Instance Running",
        ReleaseChannel::Stable => "RZed Editor Stable Instance Running",
    }
}
