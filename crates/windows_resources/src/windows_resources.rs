...
pub fn compile(manifest: bool) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let (icon_filename, product_name) = match channel {
        "stable" => ("app-icon.ico", "RZed"),
        "preview" => ("app-icon-preview.ico", "RZed Preview"),
        "nightly" => ("app-icon-nightly.ico", "RZed Nightly"),
        _ => ("app-icon-dev.ico", "RZed Dev"),
    };
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "CompanyName", "RZed\0"
            VALUE "LegalCopyright", "Copyright 2022 - 2026 RZed\0"
        END
    END
    BLOCK "VarFileInfo"
    BEGIN
