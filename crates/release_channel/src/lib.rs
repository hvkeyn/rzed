...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "RZed-Editor-Dev",
        ReleaseChannel::Nightly => "RZed-Editor-Nightly",
        ReleaseChannel::Preview => "RZed-Editor-Preview",
        ReleaseChannel::Stable => "RZed-Editor-Stable",
    }
}
...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "RZed Dev",
            ReleaseChannel::Nightly => "RZed Nightly",
            ReleaseChannel::Preview => "RZed Preview",
            ReleaseChannel::Stable => "RZed",
        }
    }
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "dev.rzed.RZed-Dev",
            ReleaseChannel::Nightly => "dev.rzed.RZed-Nightly",
            ReleaseChannel::Preview => "dev.rzed.RZed-Preview",
            ReleaseChannel::Stable => "dev.rzed.RZed",
        }
    }
